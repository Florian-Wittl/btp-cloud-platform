...
You can configure your application to use a database connection so that the application can persist its data. This configuration is applicable for the [TomEE 10](tomee-10-66e808e.md), [Tomcat 10](tomcat-10-97d0e34.md), and [Tomcat 11](tomcat-11-7c854a1.md) application containers. See:

-   [Database Connection Configuration Details](database-connection-configuration-details-f0d2d05.md)

-   [Connect an Application to PostgreSQL via TLS Certificate](connect-an-application-to-postgresql-via-tls-certificate-a04a06d.md)
